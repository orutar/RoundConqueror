...
OffsetUV_Y_1("OffsetUV_Y_1", Range(-1, 1)) = -0.455
OffsetUV_ZoomX_1("OffsetUV_ZoomX_1", Range(0.1, 10)) = 4.212
OffsetUV_ZoomY_1("OffsetUV_ZoomY_1", Range(0.1, 10)) = 4.636
...
{
float2 ZoomUV_2 = ZoomUV(i.texcoord,0.411,0.5,0.5);
float4 _DisplacementPack_2 = DisplacementPack(ZoomUV_2,DisplacementPack_2,-0.311,-0.202,-1.218,1,1);
float2 _Simple_Displacement_1 = SimpleDisplacementUV(i.texcoord,_DisplacementPack_2.r*_DisplacementPack_2.a,0,-0.104);
float2 DistortionUV_1 = DistortionUV(_Simple_Displacement_1,86.789,7.991,0.215,0.692,0.354);
float2 DistortionUV_2 = DistortionUV(DistortionUV_1,10,75.543,0.139,0.13,1);
...
float4 HdrCreate_1 = HdrCreate(OperationBlend_1,0);
